...
import 'schema/sadsds_record.dart';
...
export 'schema/sadsds_record.dart';
...
/// Functions to query SadsdsRecords (as a Stream and as a Future).
Future<int> querySadsdsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SadsdsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SadsdsRecord>> querySadsdsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SadsdsRecord.collection,
      SadsdsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SadsdsRecord>> querySadsdsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
